...
export function BulkActionsBar({
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col sm:flex-row gap-4 py-3 px-6
                    bg-dark-900/95 backdrop-blur-sm border-b border-dark-600 shadow-lg">
